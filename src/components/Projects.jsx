    ...
    <section id="projects" className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:px-8 lg:py-24">
      ...
      >
        ...
        <p className="mt-4 max-w-2xl text-base leading-7 text-slate-600 dark:text-slate-300">
          Algunos de los proyectos en los que trabajé, combinando desarrollo full-stack, diseño y resolución de problemas reales.
        </p>
      </motion.div>
            ...
            <button
              ...
              className={`rounded-full px-4 py-2 text-sm font-semibold transition ${
                isActive
                  ...
                  : 'border border-slate-300 bg-white text-slate-700 hover:border-cyan-500 hover:text-cyan-600 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200'
              }`}
            >
              {filter.label}
            </button>
